...
namespace Registration {
    ...
    std::string getRegistrationMode(const RegistrationMode& registrationMode) {
        ...
        switch (registrationMode) {
            case RegistrationMode::SVD_ALIGNED:
                mode_name = std::string("SVD_ALIGNED");
                break;
            case RegistrationMode::Point2Point:
                mode_name = std::string("Point2Point");
                break;
            case RegistrationMode::Point2Line:
                mode_name = std::string("Point2Line");
                break;
            case RegistrationMode::Point2Plane:
                mode_name = std::string("Point2Plane");
                break;
            case RegistrationMode::NDT_ALIGNED:
                mode_name = std::string("NDT_ALIGNED");
                break;
            case RegistrationMode::NICP:
                mode_name = std::string("NICP");
                break;
            case RegistrationMode::IMSL_ICP:
                mode_name = std::string("IMSL_ICP");
                break;
            default:
                mode_name = std::string("Unknown Registration Mode");
                break;
        }
        return mode_name;
    }
